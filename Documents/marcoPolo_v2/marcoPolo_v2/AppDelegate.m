...
-(void)performURLUpdate
{
    ...
    contact2Search.contact_id = [self.importID copy];
    contact2Search.contact_name = [self.importName copy];
    contact2Search.contact_phone_number = [self.importNumber copy];
    
    NSArray *contacts = [[self getAllContacts] copy];
