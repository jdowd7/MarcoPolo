...
- (id)initWithCoder:(NSCoder *)decoder {
    ...
    self.homeDirectory = [decoder decodeObjectForKey:@"homeDirectory"];
    self.publicKeyRingPath = [decoder decodeObjectForKey:@"publicKeyRingPath"];
    self.secretKeyRingPath = [decoder decodeObjectForKey:@"secretKeyRingPath"];
    self.password = [decoder decodeObjectForKey:@"password"];
    self.availableKeys = [decoder decodeObjectForKey:@"availableKeys"];
    self.armored = [decoder decodeBoolForKey:@"armored"];
...
- (void)encodeWithCoder:(NSCoder *)encoder {
    ...
    [encoder encodeObject:self.homeDirectory forKey:@"homeDirectory"];
    [encoder encodeObject:self.publicKeyRingPath   forKey:@"publicKeyRingPath"];
    [encoder encodeObject:self.secretKeyRingPath   forKey:@"secretKeyRingPath"];
    [encoder encodeObject:self.password   forKey:@"password"];
    [encoder encodeObject:self.availableKeys   forKey:@"availableKeys"];
    [encoder encodeBool:self.armored forKey:@"armored"];
